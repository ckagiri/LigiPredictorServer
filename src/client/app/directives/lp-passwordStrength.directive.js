    ...
    (function (directives) {
        ...
        var LpPasswordStrength = /** @class */ (function () {
            function LpPasswordStrength() {
                ...
                this.template = '<span class="password-strength-indicator"><span></span><span></span><span></span><span></span></span>';
                this.link = this.linkFn;
            }
            LpPasswordStrength.instance = function () {
                return new LpPasswordStrength();
            };
            LpPasswordStrength.prototype.linkFn = function (scope, element, attrs, ngModel) {
...
//# sourceMappingURL=lp-passwordStrength.directive.js.map