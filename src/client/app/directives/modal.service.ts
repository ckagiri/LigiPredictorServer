...
namespace app.core {
  ...
  Modal.$inject = ['$log', '$q', '$rootScope', '$uibModal']
  function Modal($log: ng.ILogService, $q: ng.IQService, $rootScope: ng.IRootScopeService, $uibModal: any) {
    let instanceCache:any = {};

    let getScope = function(model: any) {
      ...
      scope.setError = function(err: any, message: string) {
    ...
    return function(options: any) {
      ...
      let instance = $uibModal.open(options);
